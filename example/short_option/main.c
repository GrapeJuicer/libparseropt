...
int main(int argc, char *argv[])
{
    ...
    PsrArgumentObject_t options[] = {
        {.id = ID_NO_ARG  , .short_opt = 'n', .long_opt = NONE_LONG_OPT, .has_arg = NO_ARGUMENT      , .priority = NONE_PRIORITY, .callfunc = NONE_CALLFUNC},
        {.id = ID_REQ_ARG , .short_opt = 'r', .long_opt = NONE_LONG_OPT, .has_arg = REQUIRE_ARGUMENT , .priority = NONE_PRIORITY, .callfunc = NONE_CALLFUNC},
        {.id = ID_OPT_ARG , .short_opt = 'o', .long_opt = NONE_LONG_OPT, .has_arg = OPTIONAL_ARGUMENT, .priority = NONE_PRIORITY, .callfunc = NONE_CALLFUNC},
        PSR_ARG_END
    };
